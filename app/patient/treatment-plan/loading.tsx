export default function TreatmentPlanLoading() {
  return (
    <main className="grid gap-6 p-4 sm:p-6 lg:p-8">
      <div className="grid gap-3">
        <div className="h-4 w-28 animate-pulse rounded-full bg-[color:var(--ui-border)]" />
        <div className="h-10 w-56 animate-pulse rounded-full bg-[color:var(--ui-border)]" />
        <div className="h-4 w-full max-w-2xl animate-pulse rounded-full bg-[color:var(--ui-border)]" />
      </div>

      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        <div className="h-[36rem] animate-pulse rounded-[2rem] border border-[color:var(--ui-border)] bg-[color:var(--ui-surface)]" />
